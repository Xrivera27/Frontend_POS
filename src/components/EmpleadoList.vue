<template>
    ...
    <div class="clientes-wrapper">
      ...
      <button id="btnAdd" class="btn btn-primary" @click="openModal" style="width: 200px; white-space: nowrap;">Agregar Usuario</button>
      ...
      <div v-if="isModalOpen" class="modal">
        <div class="modal-content">
          ...
          <div class="form-group">
            <label>Usuario:</label>
            <input v-model="clienteForm.nombreusuario" type="text" required>
          </div>
          
          <div class="form-group">
          <label>Contraseña:</label>
          <input v-model="clienteForm.contraseña" type="password" required>
         </div>
          ...
          <div class="form-group" >
            <label>Rol:</label>
            <select v-model="clienteForm.rol"  required style="width: 30%; height: 35px; font-size: 16px; padding: 5px;">
          ...
          <div class="form-group">
            <label>Estado:</label>
            <select v-model="clienteForm.estado" required style="width: 30%; height: 35px; font-size: 16px; padding: 5px;">
